...
namespace RageLib.Resources.Common
{
    ...
    public class ResourceSplitArray<T> : ResourceSystemBlock where T : IResourceSystemBlock, new()
    {
    ...
    public class SplitArrayPart<T> : ResourceSystemBlock where T : IResourceSystemBlock, new()
    {
